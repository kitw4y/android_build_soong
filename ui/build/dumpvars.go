...
func Banner(make_vars map[string]string) string {
	...
	fmt.Fprintln(b, "          \__|          $$ |                                                      ")
        fmt.Fprintln(b, " $$$$$$$\ $$\  $$$$$$\  $$$$$$$\   $$$$$$\   $$$$$$\         $$$$$$\   $$$$$$$\   ")
        fmt.Fprintln(b, "$$  _____|$$ |$$  __$$\ $$  __$$\ $$  __$$\ $$  __$$\       $$  __$$\ $$  _____|  ")
	fmt.Fprintln(b, "$$ /      $$ |$$ /  $$ |$$ |  $$ |$$$$$$$$ |$$ |  \__|      $$ /  $$ |\$$$$$$\    ")
	fmt.Fprintln(b, "$$ |      $$ |$$ |  $$ |$$ |  $$ |$$   ____|$$ |            $$ |  $$ | \____$$\   ")
	fmt.Fprintln(b, "\$$$$$$$\ $$ |$$$$$$$  |$$ |  $$ |\$$$$$$$\ $$ |            \$$$$$$  |$$$$$$$  |  ")
	fmt.Fprintln(b, "\_______|\__|$$  ____/ \__|  \__| \_______|\__|             \______/ \_______/    ")
        fmt.Fprintln(b, "              $$ |          By TechyMinati                                        ")
	fmt.Fprintln(b, "              $$ |                                                                ")
        fmt.Fprintln(b, "              \__|                                                                ")
	fmt.Fprintln(b, "==================================================================================")
	 fmt.Fprintf(b, "%s=%s\n", "CIPHER_VERSION", make_vars["CIPHER_VERSION"])
